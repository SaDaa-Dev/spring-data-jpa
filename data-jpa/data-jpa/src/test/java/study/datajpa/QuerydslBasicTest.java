...
//                .fetchFirst();
    ...
    * JPQL : select m, t from Member m left join m.team t on m.team = 'teamA'
    * */
    @Test
    ...
    * */
    ...
    public void complexCase() throws Exception{
        List<String> result = queryFactory
                .select(
                        new CaseBuilder()
                                .when(member.age.between(0, 20)).then("0~20 Old")
                                .when(member.age.between(21, 30)).then("21~30 Old")
                                .otherwise("other")
                )
                .from(member)
                .fetch();
    ...
    public void findDtoByJPQL() throws Exception{
        List<MemberDto> result = em.createQuery("select new study.datajpa.dto.MemberDto(m.userName, m.age) from Member m", MemberDto.class)
                .getResultList();
